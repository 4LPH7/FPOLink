"""Order model."""
import uuid
from sqlalchemy import Column, String, Float, Numeric, Text, ForeignKey
...
class Order(Base, TimestampMixin):
    ...
    buyer_requirement_id = Column(UUID(as_uuid=True), ForeignKey("buyer_requirements.id"), nullable=False)
